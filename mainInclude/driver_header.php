	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="nav navbar-item"><a href="busroute.php" style="color:#fff;">Bus Route</a></li>
				<li class="nav navbar-item"><a href="driver.php" style="color:#fff;">Update Form</a></li>
				<li class="nav navbar-item"><a href="busschedule_driver.php" style="color:#fff;">Bus Schedule</a></li>

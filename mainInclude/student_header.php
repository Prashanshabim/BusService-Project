	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
			    <li class="nav navbar-item"><a href="student.php" style="color:#fff;">BusService Form</a></li>
				<li class="nav navbar-item"><a href="busschedule_stu.php" style="color:#fff;">Bus Schedule</a></li>
